...
const MEMBERS = [
  ...
  { id:  9, enabled: true, name: '大沼 晶保', nameRoma: 'Akiho Onuma', role: '', birthday: '1998-10-12', avatar: 'member/onuma.png', color: '#b87840', bg: 'linear-gradient(145deg,#b87840,#d4a060)', height: '', mbti: '', fav: '', memo: '' },
  ...
  { id: 12, enabled: true, name: '田村 保乃', nameRoma: 'Hono Tamura', role: '', birthday: '1997-10-21', avatar: 'member/tamura.png', color: '#3858a8', bg: 'linear-gradient(145deg,#3858a8,#6080d0)', height: '', mbti: '', fav: '', memo: '' },
  ...
  { id: 14, enabled: true, name: '増本 綺良', nameRoma: 'Kira Masumoto', role: '', birthday: '2001-01-12', avatar: 'member/masumoto.png', color: '#4a6a3a', bg: 'linear-gradient(145deg,#4a6a3a,#7a9a60)', height: '', mbti: '', fav: '', memo: '' },
  ...
  { id: 17, enabled: true, name: '守屋 麗奈', nameRoma: 'Rena Moriya', role: '', birthday: '1999-01-02', avatar: 'member/moriya.png', color: '#3a5a8a', bg: 'linear-gradient(145deg,#3a5a8a,#6088b8)', height: '', mbti: '', fav: '', memo: '' },
  ...
  { id: 19, enabled: true, name: '石森 璃花', nameRoma: 'Rika Ishimori', role: '', birthday: '2001-01-13', avatar: 'member/ishimori.png', color: '#3a8a7a', bg: 'linear-gradient(145deg,#3a8a7a,#60b8a8)', height: '', mbti: '', fav: '', memo: '' },
  { id: 20, enabled: true, name: '遠藤 理子', nameRoma: 'Riko Endo', role: '', birthday: '2005-01-09', avatar: 'member/endo_r.png', color: '#7a3a8a', bg: 'linear-gradient(145deg,#7a3a8a,#a860b8)', height: '', mbti: '', fav: '', memo: '' },
  ...
  { id: 24, enabled: true, name: '中嶋 優月', nameRoma: 'Yuzuki Nakashima', role: '', birthday: '2002-02-17', avatar: 'member/nakasima.png', color: '#3a4a8a', bg: 'linear-gradient(145deg,#3a4a8a,#6070b8)', height: '', mbti: '', fav: '', memo: '' },
  { id: 25, enabled: true, name: '的野 美青', nameRoma: 'Mio Matono', role: '', birthday: '2005-11-08', avatar: 'member/matono.png', color: '#6a8a3a', bg: 'linear-gradient(145deg,#6a8a3a,#98b860)', height: '', mbti: '', fav: '', memo: '' },
  ...
  { id: 28, enabled: true, name: '村山 美羽', nameRoma: 'Miu Murayama', role: '', birthday: '2004-02-15', avatar: 'member/murayama.png', color: '#8a5a3a', bg: 'linear-gradient(145deg,#8a5a3a,#b88860)', height: '', mbti: '', fav: '', memo: '' },
  { id: 29, enabled: true, name: '山下 瞳月', nameRoma: 'Shizuki Yamashita', role: '', birthday: '2004-01-22', avatar: 'member/yamasita.png', color: '#5a3a8a', bg: 'linear-gradient(145deg,#5a3a8a,#8860b8)', height: '', mbti: '', fav: '', memo: '' },
  ...
  { id: 32, enabled: true, name: '勝又 春', nameRoma: 'Haru Katsumata', role: '', birthday: '2003-01-24', avatar: 'member/katumata.png', color: '#8a573a', bg: 'linear-gradient(145deg,#8a573a,#60b898)', height: '', mbti: '', fav: '', memo: '' },
  ...
  { id: 36, enabled: true, name: '目黒 陽色', nameRoma: 'Hiiro Meguro', role: '', birthday: '2005-01-24', avatar: 'member/meguro.png', color: '#a73f0f', bg: 'linear-gradient(145deg,#a73f0f,#60b898)', height: '', mbti: '', fav: '', memo: '' },
